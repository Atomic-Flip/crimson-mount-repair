...
If quest-unlocked (aka legendary / unique) mounts (Silver Fang, Snow White Deer, Cloud Cart, Sky Streaker, and similar) disappeared from your mount menu after the 1.04 patch, this tool can detect and fix the affected records in your save file.
